...
from ..entities import Snippet, SnippetInstruction
from ..retriever import DocumentRetriever
from .base import PromptBuilder
from .utils import load_preamble, load_user_preamble


class SnippetPromptBuilder(PromptBuilder):
    def __init__(
        self,
        ...
        self.retriever.set_document_class(Snippet)

    def _create_rag_preamble_from_emails(self, emails: List[Snippet]) -> str:
        rag_context = self._create_rag_context_from_emails(emails)
        return self.rag_preamble.format(rag_context=rag_context)

    def _create_rag_context_from_emails(self, emails: List[Snippet]) -> str:
