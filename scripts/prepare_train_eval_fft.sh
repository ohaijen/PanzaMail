    ...
    for batch_size in "${batch_sizes[@]}"; do
      for n_epochs in "${epochs[@]}"; do
        ...
        echo python runner.py \
          ...
          user=${user} \
          checkpoint=/nfs/scistore19/alistgrp/eiofinov/PanzaMail/scripts/..//checkpoints/models/panza_${user}_anonymous-${model_name}-bf16-bs${batch_size}-fft-lr${lr}-${n_epochs}ep-seed${seed} \
